...
q5a_long %>% 
  ...
  geom_col() +
  geom_text(aes(label = paste0("n = ",n)), color = "darkgrey",
            size = 4,
  ...
  labs(title = str_wrap("Tycker du att frågorna täcker in det som är viktigt för att beskriva de grundläggande aspekterna av säkerhetskulturen på en arbetsplats?",59),
       subtitle = paste0("Antal svar totalt: ",total_n,
...
q6_long %>% 
  ...
  theme_prevent() +
    labs(title = str_wrap("Har du det senaste året varit med om en eller flera arbetsplatsolyckor som resulterat i mer än en dags frånvaro från arbetet?",70),
